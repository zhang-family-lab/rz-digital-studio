    ...
    <div>
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="prose max-w-none text-slate-700">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4 text-slate-900">2. Eligibility</h2>
            <p>You must be at least 13 years old to use our Services. By using our Services, you represent and warrant that you meet this age requirement. If you are under 18, you represent that you have your parent or guardian's permission to use the Services.</p>
          </section>

          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4 text-slate-900">3. Description of Service</h2>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4 text-slate-900">4. Payment & Subscription</h2>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4 text-slate-900">5. Refund Policy</h2>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4 text-slate-900">6. Content & Ownership</h2>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4 text-slate-900">7. Disclaimer of Warranties</h2>
            <p><strong>Independent Service:</strong> RZ Digital Studio is an independent design agency and is NOT affiliated with any university, college, or admissions committee. We provide technical and design services only.</p>
            <p className="mt-2"><strong>No Guarantee of Admission:</strong> We do not guarantee admission to any school or program. A professional portfolio is just one component of an application. We are not responsible for any rejection decisions.</p>
          </section>
          ...
          <section className="mb-8 border-t pt-8 mt-8">
            ...
            <ul className="list-disc pl-5 space-y-2 mb-4">
              <li><strong>Personal Information:</strong> Name, email address, and educational details provided voluntarily via email or request forms.</li>
              <li><strong>Scholarship Data:</strong> Information submitted for the Student Equity Scholarship is sent directly via email and is not stored in our web databases.</li>
            ...
            <p>If you have any questions about these Terms or our Privacy Policy, please contact us at: rzdigitalstudio2027@gmail.com</p>
          </section>
        </div>
      </div>
      <Footer />

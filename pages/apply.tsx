...
export default function Apply() {
    const [formData, setFormData] = useState({
        packageSelection: 'Student Elite Portfolio (299$ + 29$/mo)',
        fullName: '',
        email: '',
        identityDNA: '',
        academicTrends: '',
                ...
                {status === 'success' ? (
                    ...
                    <form onSubmit={handleSubmit} className="bg-white p-8 md:p-12 rounded-3xl shadow-sm border border-slate-200 space-y-8">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-slate-500 mb-2">Provide the 'Proof' for your portfolio. For each award, include: <strong>[Award Name] | [Selectivity, e.g., Top 5% of 200] | [Key reason you won]</strong>. This allows us to highlight your competitive edge.</p>
                            <textarea
                                id="honors"
                                name="honors"
                                required
                        ...
                        <div>
                            ...
                            <p className="text-xs text-slate-500 mb-2">List your top 2 projects. Focus on Results & Impact. Use numbers where possible (e.g., 'Coded a Python script that saved 10 hours of work' or 'Led 20 volunteers'). This gives the us 'hooks' to write your project descriptions.</p>
                            <textarea
                                id="projects"
                                name="projects"
                                rows={3}
                        ...
                        <div>
                            ...
                            <p className="text-xs text-slate-500 mb-2">Provide a link to your most significant creative work (Design, Code, Research Paper, or Art). Include a 30-word 'Creator’s Note' explaining the core problem you were trying to solve. This helps us write the 'Project Philosophy' section of your site.</p>
                            <input
                                type="url"
                        ...
                        <div>
                            ...
                            <p className="text-xs text-slate-500 mb-2">Please use the format: <strong>[Role] + [Organization] + [One Specific Impact]</strong>. Example: Founder of Coding Club - Taught 20 peers Python basics.</p>
                            <input
                                type="text"
                                id="leadership"
                                name="leadership"
                        ...
                        <div>
                            ...
                            <p className="text-xs text-slate-500 mb-2">What is one thing about you that isn't on your resume? (e.g., 'I have a black belt in Karate' or 'I can solve a Rubik’s cube in 20 seconds'). AI uses this to add 'personality' and 'humanity' to your digital brand.</p>
                            <input
                                type="text"
                                id="easterEgg"
                                name="easterEgg"
                        ...
                        <div>
                            <label htmlFor="designAesthetic" className="block text-sm font-bold text-slate-700 mb-2">Design Aesthetic | 视觉风格偏好</label>
